...
- **On the five questions labelled unanswerable, the baseline scores 0.836.** In three of them (q24, q25, q28) it states timeouts in seconds that the specification does not define (q24: "up to 15 seconds"). Every retrieval configuration declines on four of the five, all except q26, with an answer that begins "The context does not", "The provided context does not" or "The context provided does not"; each averages 0.000 on the five, except fixed 1024 (0.313).
- **On the 23 answerable questions alone, the gaps are not conclusive.** The baseline scores 0.634: above fixed 256 (0.324) and semantic (0.572), level with fixed 512 (0.634) and below fixed 1024 (0.691). A paired bootstrap over these 23 questions (20,000 resamples) gives a 95% interval for fixed 1024 minus the baseline of −0.12 to +0.23.
- **Declining an answer usually scores zero.** RAGAs asks the judge whether an answer is noncommittal and sets answer relevancy to 0 when all three of its judgements say so. Across all 140 answers, 33 begin with one of those three phrases (12 with "The context does not", 14 with "The provided context does not", 7 with "The context provided does not"), and 31 of them scored 0; the exceptions are fixed 512's q12 (0.659) and fixed 1024's q28 (0.742). Answers scored exactly 0: 18 for fixed 256, 9 for fixed 512, 6 for fixed 1024, 12 for semantic and 2 for the baseline. 16 of those 47 do not begin with any of the three phrases; fixed 256's q17, for example, names a field that StopTransaction.req does not have. Small chunks can cut field tables short: for q02 and q03, the top fixed 256 chunk ends at the table's header row, before the fields.
